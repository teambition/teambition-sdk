...
const getCustomField = (
  ...
  let commonGroupWithChoices = false
  ...
  return sdk
    .getCustomField(customFieldId, {
      ...
      withChoices: commonGroupWithChoices, // 要求存在 choices 字段
      padding: commonGroupWithChoices ? customField$ : void 0, // 避免 RDB 缓存缺少 choices 字段
    })
    .changes()
    .pipe(
